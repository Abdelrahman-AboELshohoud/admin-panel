...
const ForPartner = () => {
  ...
  const selectOptions = {
    city: [
      { value: "kazan", label: t('cityOptions.kazan') },
    ],
    partner: [
      { value: "olrusAuto", label: t('partnerOptions.olrusAuto') },
    ],
    paymentType: [
      { value: "allPaymentTypes", label: t('paymentTypeOptions.allPaymentTypes') },
    ]
  };
      ...
      <CardContent className="space-y-6">
        ...
        <div className="flex gap-6">
          {periodButtons.map((period) => (
            <Button key={period} className="flex items-center gap-2 bg-[#121212] hover:bg-[#888]">
        ...
        <Table className='items-center gap-6 p-4 bg-[#1C1C1E] rounded-xl col-span-4'>
          ...
          <TableBody>
            <TableRow className='hover:bg-transparent'>
              ...
              <TableCell>{t('currentAsOf', { date: '10.07.2023 22:32' })}</TableCell>
