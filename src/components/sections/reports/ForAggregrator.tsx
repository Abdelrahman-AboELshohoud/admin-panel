...
const ForAggregrator = () => {
  ...
  const selects = {
    ...
    partner: {
      ...
      options: [
        { value: "olrusAuto", label: t('olrusAuto') },
      ]
    }
  }
  ...
  return (
    <Card className="w-full bg-transparent max-w-4xl  text-white border-none">
      <CardHeader>
        <CardTitle className="text-2xl font-bold">{t('forAggregrator.title')}</CardTitle>
      </CardHeader>
        ...
        <Table className='items-center gap-6 p-4 bg-[#1C1C1E] rounded-xl col-span-4'>
          ...
          <TableBody>
            <TableRow className='hover:bg-transparent'>
              ...
              <TableCell>{t('forAggregrator.currentAsOf', { date: '10.07.2023 22:32' })}</TableCell>
