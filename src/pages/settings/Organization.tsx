            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="space-y-6">
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      id="organizationName"
                      placeholder={t(
                        "organizationDetails.organizationNamePlaceholder"
                      )}
                      className="bg-muted custom-input"
                    />
                  </div>
                  <div className="space-y-2">
                    <label htmlFor="taxiServiceName">
                      {t("organizationDetails.taxiServiceName")}
                    </label>
                    <Input
                      id="taxiServiceName"
                      placeholder={t(
                        "organizationDetails.taxiServiceNamePlaceholder"
                      )}
                      className="bg-muted custom-input"
                    />
                  </div>
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    <label htmlFor="legalAddress">
                      {t("organizationDetails.legalAddress")}
                    </label>
                    <Input
                      id="legalAddress"
                      placeholder={t(
                        "organizationDetails.legalAddressPlaceholder"
                      )}
                      className="bg-muted custom-input"
                    />
                  </div>
                  <div className="space-y-2">
                    <label htmlFor="postalAddress">
                      {t("organizationDetails.postalAddress")}
                    </label>
                    <Input
                      id="postalAddress"
                      placeholder={t(
                        "organizationDetails.postalAddressPlaceholder"
                      )}
                      className="bg-muted custom-input"
                    />
                  </div>
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    <label htmlFor="phone">
                      {t("organizationDetails.organizationPhone")}
                    </label>
                    <Input
                      id="phone"
                      type="tel"
                  ...
                  <div className="space-y-2">
                    <label htmlFor="email">
                      {t("organizationDetails.organizationEmail")}
                    </label>
                    <Input
                      id="email"
                      type="email"
                ...
                <div className="space-y-4">
                  <h3 className="text-lg font-semibold">
                    {t("organizationDetails.contactPerson")}
                  </h3>
                  <div className="grid gap-4 md:grid-cols-3">
                    <div className="space-y-2">
                      <label htmlFor="contactLastName">
                        {t("organizationDetails.lastName")}
                      </label>
                      <Input
                        id="contactLastName"
                        className="bg-muted custom-input"
                    ...
                    <div className="space-y-2">
                      <label htmlFor="contactFirstName">
                        {t("organizationDetails.firstName")}
                      </label>
                      <Input
                        id="contactFirstName"
                        className="bg-muted custom-input"
                    ...
                    <div className="space-y-2">
                      <label htmlFor="contactMiddleName">
                        {t("organizationDetails.middleName")}
                      </label>
                      <Input
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    <div className="space-y-2">
                      <label htmlFor="contactPhone">
                        {t("organizationDetails.contactPhone")}
                      </label>
                      <Input
                        id="contactPhone"
                        type="tel"
                    ...
                    <div className="space-y-2">
                      <label htmlFor="contactEmail">
                        {t("organizationDetails.contactEmail")}
                      </label>
                      <Input
                        id="contactEmail"
                        type="email"
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="space-y-2">
                    <label htmlFor="directorName">
                      {t("organizationDetails.directorFullName")}
                    </label>
                    <Input
                      id="directorName"
                  ...
                  <div className="space-y-2">
                    <label htmlFor="directorPosition">
                      {t("organizationDetails.position")}
                    </label>
                    <Input
                      id="directorPosition"
