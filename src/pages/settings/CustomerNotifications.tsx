...
const notificationSettings = [
  ...
  {
    id: "executorAcceptedOrder",
    label: "executorAcceptedOrder",
    defaultValue: "sms",
  },
          ...
          {notificationSettings.map((setting) => (
            ...
            >
              <span className="text-sm">
                {t(`customerNotifications.${setting.label}`)}
              </span>
              <Select
              ...
              >
                ...
                <SelectContent>
                  <SelectItem value="nothing">
                    {t("customerNotifications.nothing")}
                  </SelectItem>
                  <SelectItem value="sms">
                    {t("customerNotifications.smsToClient")}
                  </SelectItem>
                  <SelectItem value="push">
                    {t("customerNotifications.pushToClient")}
                  </SelectItem>
                </SelectContent>
              </Select>
            </div>
