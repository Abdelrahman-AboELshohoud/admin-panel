...
export default function DriverSettings() {
  ...
  const Content = () => {
    return (
      <div className="card-shape flex flex-col gap-4">
        ...
        <div className="space-y-6">
          ...
          <SelectsWithLabel
            placeholder="10%"
            options={Array.from({ length: 10 }, (_, i) => (i * 10).toString())}
            value="10%"
  ...
  const tabs = [
    {
      title: t("driversSettings.taxiDriver"),
      value: "taxi",
    },
    {
      title: t("driversSettings.driver"),
      value: "driver",
    },
  ];
